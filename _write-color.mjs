...
const content = [
  ...
  `  {id: 'red', label: '${red}', value: '#ff6b6b', face: '\u2764\uFE0F'},`,
  `  {id: 'orange', label: '${orange}', value: '#ff9f43', face: '\uD83E\uDDE1'},`,
  `  {id: 'yellow', label: '${yellow}', value: '#ffd93d', face: '\uD83D\uDC9B'},`,
  `  {id: 'green', label: '${green}', value: '#6bcb77', face: '\uD83D\uDC9A'},`,
  `  {id: 'blue', label: '${blue}', value: '#4d96ff', face: '\uD83D\uDC99'},`,
  `  {id: 'purple', label: '${purple}', value: '#c77dff', face: '\uD83D\uDC9C'},`,
  '];',
  '',
...
fs.writeFileSync('src/games/level1/color-touch/ColorTouchGame.tsx', content, 'utf8');
console.log('wrote', content.includes(red));
